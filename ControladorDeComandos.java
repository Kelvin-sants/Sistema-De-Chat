...
public class ControladorDeComandos {
    ...
    public void interpretaComando(String comando, GerenciaUsuario gerenciaUsuarios, GerenciaSalas gerenciaSalas){           //funcao principal da classe
        ...
        if(comando.startsWith("/login")){                               //comando /login
            if(comando.length() > 7){                                         //verifica se o nome é válido
                ...
                if(!nome.isEmpty()){                                            //verifica se o nome não é vazio
                    ...
                    }else{                                                       //se não conseguir adicionar o usuário ao servidor
                        usuario.setNome(null);                              //coloca null de volta no campo nome do usuario
            ...
            if(usuario.getNome() != null){                                          //se o usuario estiver logado
                ...
                usuario.getOut().println("SERVIDOR: É necessário fazer login primeiro; Para fazer login use: /login (nome)");
                return;
            }
        }
            ...
            if(usuario.getNome() != null){                                                  //se o usuario estiver logado
                ...
                usuario.getOut().println("SERVIDOR: nome da sala inválido");                //se o nome for inválido
                return;          
            }else{                                                                            //se o usuário não estiver logado
                usuario.getOut().println("SERVIDOR: É necessário fazer login primeiro; Para fazer login use: /login (nome)");   //informa o usuário que ele não está logado
                return;
            }
        }

        else if (comando.equals("/salas")){                //comando "/salas"
            if(usuario.getNome() != null){                              //verifica se o usuário está logado
            ...
            if(usuario.getNome() != null){                                                                 //verifica se o usuário está logado
                if(comando.length() > 9){                                                                  //verifica se o nomeExpulsar é válido
        ...
        else{                                                                   //caso o usuário mande um comando inexistente
            if(usuario.getNome() != null){                                      //se o usuário estiver logado
                usuario.getOut().println("SERVIDOR: Entrada incorreta");      //avisa que o comando é invalido
            }else{                                                              //se o usuário não estiver logado
                usuario.getOut().println("SERVIDOR: É necessário fazer login primeiro; Para fazer login use: /login (nome)");   //informa o usuário que ele não está logado
            }
            return;
